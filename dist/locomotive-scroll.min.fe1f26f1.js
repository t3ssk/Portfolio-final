...
!function (t, e) {
  ...
  var y = t(function (t, e) {
    ...
    return l(i, f), o(i, [{
      ...
      key: "scrollTo",
      value: function value(t, e, i, s, n, o) {
        var l,
            r = e ? parseInt(e) : 0;
  ...
  var J = function J(o, e, l, i) {
    ...
    return l(n, f), o(n, [{
      ...
      key: "updateScroll",
      value: function value(t) {
        this.isScrolling || this.isDraggingScrollbar ? this.instance.scroll.y = P(this.instance.scroll.y, this.instance.delta.y, this.lerp) : this.instance.scroll.y > this.instance.limit ? this.setScroll(this.instance.scroll.x, this.instance.limit) : this.instance.scroll.y < 0 ? this.setScroll(this.instance.scroll.x, 0) : this.setScroll(this.instance.scroll.x, this.instance.delta.y);
      }
    }, {
      key: "addDirection",
      value: function value() {
      ...
      value: function value() {
        ...
        this.els = [], this.parallaxElements = [], this.sections.forEach(function (t, S) {
          k.sections[S].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
            ...
            var g = [0, 0];
            if (d) for (var w = 0; w < d.length; w++) {
              "string" == typeof d[w] ? d[w].includes("%") ? g[w] = parseInt(d[w].replace("%", "") * k.windowHeight / 100) : g[w] = parseInt(d[w]) : g[w] = d[w];
            }
            var b = {
              el: t,
              id: e,
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","locomotive-scroll.min.js"], null)
